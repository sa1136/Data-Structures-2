...
public:
    ...
    // Time complexity: O(n * sum) - n elements, each can be checked against sum/2 possible target values
    // Space complexity: O(n * sum) - DP table of size n * (sum/2 + 1) to store all subproblem results
