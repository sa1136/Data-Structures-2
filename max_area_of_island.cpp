...
public:
    ...
    // Time complexity: O(m*n) for each island - visit each cell in the island once
    // Space complexity: O(m*n) for visited array - tracks all cells, plus O(m*n) recursion stack in worst case
