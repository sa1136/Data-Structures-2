...
public:
    ...
    // Time complexity: O(n) - single pass through array, track minimum and update max difference
    // Space complexity: O(1) - only uses constant extra variables (minVal, maxDiff)
